...
public class Auto3Command extends SequentialCommandGroup{
    ...
    public Auto3Command(DriveSubsystem subsystem, IntakeSubsystem intakeSubsystem, IndexSubsystem indexSubsystem, ShooterSubsystem shooterSubsystem, BackspinSubsystem backspinSubsystem, Trajectory _trajectory) {
        ...
        andThen(new ShootCommand(4200, 4400, false, true, m_shooterSubsystem, m_intakeSubsystem, m_indexSubsystem, m_backspinSubsystem).withTimeout(2.5));
        ...
        andThen(new ShootCommand(4200, 4400, false, true, m_shooterSubsystem, m_intakeSubsystem, m_indexSubsystem, m_backspinSubsystem).withTimeout(5));
